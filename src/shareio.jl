...
# no protection at all (the reference dataset has 372 runs, one tracking open each). Rather than grow
# two more private copies of the same loop, every one of them
